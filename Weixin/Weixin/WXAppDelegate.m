...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    NavController *navView = [[NavController alloc] initWithRootViewController:loginView];
    
//    [navView setNavigationBarHidden:NO];
//    [navView.navigationController.navigationBar setBackgroundColor:[UIColor blackColor]];
