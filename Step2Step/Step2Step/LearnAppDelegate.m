...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    HypnosisView *anotherView = [[HypnosisView alloc] initWithFrame:CGRectMake(20, 30, 50, 50)];
    [anotherView setBackgroundColor:[UIColor purpleColor]];
...
- (void)applicationDidEnterBackgcdround:(UIApplication *)application
{
